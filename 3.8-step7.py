#3.8 Code Challenge: Solve the String Reconstruction Problem.
...
f = open("/Users/denniskenbeek/Downloads/dataset_327613_7.txt", "r")
data = f.read().split('\n')
